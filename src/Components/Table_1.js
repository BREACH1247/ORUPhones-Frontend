...
export default function CustomizedTables() {
    ...
    const baseURL = "https://oru-backend.onrender.com/gettable1"
    useEffect(() => {
  ...
  return (
    <div className='mx-[20rem] glass p-8'>
      <div  className='text-white mb-4'>Type 1 :- Users which have income lower than $5 USD and have a car of brand “BMW” or “Mercedes”.</div>
