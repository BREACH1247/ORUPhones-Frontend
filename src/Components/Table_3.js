...
export default function CustomizedTables3() {
    ...
    const baseURL = "https://oru-backend.onrender.com/gettable3"
    useEffect(() => {
  ...
  return (
    <div className='mx-[20rem] glass p-8'>
      <div  className='text-white mb-4'>Type 3 :- "Users whose last name starts with “M” and has a quote character length greater than 15 and email includes his/her last name.”.</div>
